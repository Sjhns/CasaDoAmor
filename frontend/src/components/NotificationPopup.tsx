...
const NotificationItem = ({ notification }: NotificationItemProps) => {
            ...
            case "vencido":
                return (
                    <>
                        ...
                        <span className="text-sm text-gray-600">
                            Vencido em: {formatDate(notification.expiryDate)}
                        </span>
                    </>
                );
            case "quase-esgotado":
                return (
                    <>
                        ...
                        <span className="text-sm text-gray-600">
                            Quantidade atual: {notification.quantity}
                        </span>
                    </>
                );
            case "esgotado":
    ...
    const handleGoToStock = () => {
        ...
        // Navega para o dashboard já filtrando pelo nome do remédio
        navigate("/", { state: { search: notification.medicineName } });
    };
