...
// Repare que recebemos { isOpen, onClose, message } como argumentos
function ErrorModal({ isOpen, onClose, message }: ErrorModalProps) {
  
  // Se não estiver aberto, o componente não renderiza NADA.
  if (!isOpen) {
    return null;
  }

  // Se estiver aberto, renderiza o modal.
  // Note que troquei "class" por "className" e "onclick" por "onClick"
  return (
        ...
        <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
          ...
          <div className="mt-5 sm:mt-6">
            <button
                ...
                onClick={onClose} // Aqui chamamos a função que recebemos do "pai"
            >
              OK
            </button>
          </div>
