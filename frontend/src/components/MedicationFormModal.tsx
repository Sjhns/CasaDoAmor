            ...
            >
              ...
              <div>
                <div className="flex flex-col gap-1.5">
                  ...
                  >
                    ...
                    {denominacoes.map((denominacao) => (
                      <option key={denominacao.id} value={denominacao.id}>
                        {denominacao.nome}
                      </option>
                    ))}
                  </select>
                  {errors.denominacaoGenericaId && (
                    <p className="text-red-500 text-xs mt-0.5 flex items-center gap-1">
                      <span>⚠</span> {errors.denominacaoGenericaId.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  <button
                    type="button"
                    className="mt-2 text-blue-600 text-sm hover:underline pl-1"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  {errors.categoriaTerapeutica && (
                    <p className="text-red-500 text-xs mt-0.5 flex items-center gap-1">
                      <span>⚠</span> {errors.categoriaTerapeutica.message}
                    </p>
                  )}
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  {errors.laboratorioFabricante && (
                    <p className="text-red-500 text-xs mt-0.5 flex items-center gap-1">
                      <span>⚠</span> {errors.laboratorioFabricante.message}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  {errors.viaDeAdministracao && (
                    <p className="text-red-500 text-xs mt-0.5 flex items-center gap-1">
                      <span>⚠</span> {errors.viaDeAdministracao.message}
                    </p>
                  )}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  {errors.estoqueMinimo && (
                    <p className="text-red-500 text-xs mt-0.5 flex items-center gap-1">
                      <span>⚠</span> {errors.estoqueMinimo.message}
                    </p>
                  )}
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    placeholder="100"
                    /* */
                    {...register("estoqueMaximo")} /* <-- ATENÇÃO AO ACENTO */
                  />
                  {errors.estoqueMaximo /* */ && (
                    <p className="text-red-500 text-xs mt-0.5 flex items-center gap-1">
                      <span>⚠</span> {errors.estoqueMaximo.message}
                    </p>
                  )}
                </div>
              </div>
